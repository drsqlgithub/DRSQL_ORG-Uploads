--Uses Object Created in ForeignKey$Scripting.sql, available in this same github folder

CREATE OR ALTER PROCEDURE [Utility].foreign_key$batch_drop
( 
...
CREATE OR ALTER PROCEDURE [Utility].foreign_key$batch_recreate 
AS 
-- ---------------------------------------------------------------- 
