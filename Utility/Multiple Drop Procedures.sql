...
CREATE OR ALTER PROCEDURE [Utility].relationships$remove
(
...
go
CREATE OR ALTER PROCEDURE [Utility].checkConstraints$remove
(
	@table_schema		sysname = '%', 
	@table_name		sysname = '%',
...
CREATE OR ALTER PROCEDURE [Utility].defaultConstraints$remove
(
	@table_schema		sysname = '%',
	@table_name		sysname = '%',
	@constraint_name	sysname = '%',
...
go
CREATE OR ALTER PROCEDURE [Utility].indexes$remove 
(
...
CREATE OR ALTER PROCEDURE [Utility].uniqueConstraints$remove
(
    @table_name sysname, --will accept a wildcard 
    @index_name sysname, --will accept a wildcard
    @table_schema sysname = '%'
...
CREATE OR ALTER PROCEDURE [Utility].primaryKeyConstraints$remove
(
    @table_name sysname, --will accept a wildcard 
    @index_name sysname, --will accept a wildcard
    @table_schema sysname = '%'
...
CREATE OR ALTER PROCEDURE [Utility].synonyms$remove
(
...
CREATE OR ALTER PROCEDURE [Utility].codedObjects$remove
(
    @object_name sysname, 
...
CREATE OR ALTER PROCEDURE [Utility].columns$changeCollation
(
...
CREATE OR ALTER PROCEDURE [Utility].computedColumns$remove
(
    @table_name sysname, 
    @column_name sysname,
    @table_schema sysname = '%'
...
CREATE OR ALTER PROCEDURE [Utility].indexes$disableAllExceptPK
(
    @table_name sysname, --will accept a wildcard
    @index_name sysname ,--will accept a wildcard
    @schema_name sysname = '%',
