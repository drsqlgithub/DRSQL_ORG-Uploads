...
CREATE OR ALTER TABLE [Utility].WaitForSync
(
...
CREATE OR ALTER PROCEDURE [Utility].WaitForSync$Reset
AS
----------------------------------------------------------------------------------------------
...
CREATE OR ALTER PROCEDURE [Utility].WaitForSync$ViewTime
...
CREATE OR ALTER PROCEDURE [Utility].WaitForSync$StartWait
(
